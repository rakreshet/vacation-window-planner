...
test('manual dates can be compared without a search month or preferred length', async () => {
...
test('a matching result date opens comparison and returning preserves Search and feedback', async () => {
  const requests: Array<{ url: string; body: unknown }> = []
  const search = {
    search_id: 'search-id',
    recommendations: [
