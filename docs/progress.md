...
The next implementation PR is **P0 11**, the pure vacation-window generator. The foundation follow-ups and P0 06–10 are in review, and the core Phase 0 product decisions have been resolved. [Operational choices](open-decisions.md) remain for the relevant implementation tasks.
