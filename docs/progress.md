...
| AP 08 | Same-browser saved annual plans and explicit reopening/recalculation | AP 07 | Preparing PR | Immutable browser snapshots; 107 frontend tests; live reload and separate recalculation verified |
